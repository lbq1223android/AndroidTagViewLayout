...
public class TopRoundedImageView extends ImageView {
  ...
  public TopRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    mCornerRadii[CORNER_BOTTOM_RIGHT] = -1;
    mCornerRadii[CORNER_BOTTOM_LEFT] = -1;
    ...
    if (drawable instanceof RoundedDrawable) {
      ...
      if (mCornerRadii != null) {
        ((RoundedDrawable) drawable).setCornerRadius(mCornerRadii[CORNER_TOP_LEFT],
            mCornerRadii[CORNER_TOP_RIGHT], 0, 0);
      }
  ...
  public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float bottomRight) {
    ...
    mCornerRadii[CORNER_TOP_RIGHT] = topRight;
    mCornerRadii[CORNER_BOTTOM_LEFT] = 0;
    mCornerRadii[CORNER_BOTTOM_RIGHT] = 0;
